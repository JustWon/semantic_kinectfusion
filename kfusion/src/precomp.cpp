...
kfusion::device::SemanticVolume::SemanticVolume(elem_type* _data, elem_type* _label_histogram, int3 _dims, float3 _voxel_size, float _trunc_dist, int _max_weight)
