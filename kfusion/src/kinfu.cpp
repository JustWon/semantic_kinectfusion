...
//            loop_closure_edge->setVertex(0, graph_.vertex(51));
//            loop_closure_edge->setVertex(1, graph_.vertex(179));
...
//            edge_id++;
            ...
            {
				double temp[7] = {0,};
				graph_.vertex(5*i)->getEstimateData(temp);
