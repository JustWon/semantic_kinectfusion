...
#ifndef KFUSION_SEMANTIC_VOLUME_HPP
#define KFUSION_SEMANTIC_VOLUME_HPP
...
namespace kfusion
{
    namespace cuda
    {
         ...
         * @brief Semantic volume class
         */
        class KF_EXPORTS SemanticVolume
        {
        public:
...
#pragma mark Initialization
             ...
             */
            SemanticVolume (const cv::Vec3i &dims);
...
#pragma mark Usage
            ...
            /**
             * @name fetchColors
             * @fn void fetchColors(const DeviceArray<Point>& cloud, DeviceArray<RGB>& semantics) const
             ...
             */
            void fetchSemantics(const DeviceArray<Point>& cloud, DeviceArray<RGB>& semantics) const;
